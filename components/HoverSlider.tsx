...
>(({ children, className, initialSlide = 0, ...props }, ref) => {
  const [activeSlide, setActiveSlide] = React.useState<number>(initialSlide);
...
/* Panneau d'aperçu révélé en clip-path — variante div de HoverSliderImage,
